    ...
    <div class="max-w-[95%] mx-auto p-2 sm:p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg">
            ...
            <div class="p-4 sm:p-6">
                <form method="post" action="{{ route('admin.news.store') }}" enctype="multipart/form-data" id="newsForm" onsubmit="return prepareForm()">
                    @csrf
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input type="checkbox" name="is_breaking" value="1" class="sr-only peer" {{ old('is_breaking') ? 'checked' : '' }}>
                                        ...
                                        <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                                            ...
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input type="checkbox" name="show_in_slider" value="1" class="sr-only peer" {{ old('show_in_slider') ? 'checked' : '' }}>

...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400">قم بإضافة إعلان جديد مع تحديد موقعه وتفاصيله</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
            <div class="p-6 sm:p-8">
                ...
                <form action="{{ route('admin.advertisements.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <label class="relative flex items-center p-4 border dark:border-gray-700 rounded-xl cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 group">
                                <input type="radio" name="position" value="header" class="hidden peer" {{ old('position') == 'header' ? 'checked' : '' }}>
                            ...
                            <label class="relative flex items-center p-4 border dark:border-gray-700 rounded-xl cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 group">
                                <input type="radio" name="position" value="sidebar" class="hidden peer" {{ old('position') == 'sidebar' ? 'checked' : '' }}>
                                <div class="flex flex-col items-center flex-1 p-2">
                                    <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <!-- إعلان تحت الناف بار -->
                            <label class="relative flex items-center p-4 border dark:border-gray-700 rounded-xl cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 group">
                                <input type="radio" name="position" value="below_navbar" class="hidden peer" {{ old('position') == 'below_navbar' ? 'checked' : '' }}>
                                <div class="flex flex-col items-center flex-1 p-2">
                                    <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <!-- إعلان التذييل -->
                            <label class="relative flex items-center p-4 border dark:border-gray-700 rounded-xl cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 group">
                                <input type="radio" name="position" value="footer" class="hidden peer" {{ old('position') == 'footer' ? 'checked' : '' }}>
                                <div class="flex flex-col items-center flex-1 p-2">
                                    <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <!-- إعلان بين الأقسام -->
                            <label class="relative flex items-center p-4 border dark:border-gray-700 rounded-xl cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 group">
                                <input type="radio" name="position" value="between_sections" class="hidden peer" {{ old('position') == 'between_sections' ? 'checked' : '' }}>
                                <div class="flex flex-col items-center flex-1 p-2">
                                    <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                                        <i class="fas fa-grip-lines text-xl text-blue-500 dark:text-blue-400"></i>
                                    </div>
                    ...
                    <!-- Image Upload -->
                    <div class="relative">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">صورة الإعلان</label>

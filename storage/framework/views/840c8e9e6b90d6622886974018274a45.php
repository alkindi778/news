        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-4 w-full">
                    <a href="<?php echo e(route('admin.news.create')); ?>" class="flex items-center justify-center px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg w-full">
                        <i class="fas fa-newspaper ml-2 text-xl"></i>
                        إضافة خبر
                    </a>
                    <a href="<?php echo e(route('admin.opinions.create')); ?>" class="flex items-center justify-center px-4 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg w-full">
                        <i class="fas fa-pen-alt ml-2 text-xl"></i>
                        إضافة مقال
                    </a>
                    <a href="<?php echo e(route('admin.writers.create')); ?>" class="flex items-center justify-center px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg w-full">
                        <i class="fas fa-user-edit ml-2 text-xl"></i>
                        إضافة كاتب
                    </a>
                    <a href="<?php echo e(route('admin.videos.create')); ?>" class="flex items-center justify-center px-4 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg w-full">
                        <i class="fas fa-video ml-2 text-xl"></i>
                        إضافة فيديو
                    </a>
                    <a href="<?php echo e(route('admin.newspaper-covers.create')); ?>" class="flex items-center justify-center px-4 py-3 bg-yellow-600 hover:bg-yellow-700 text-white font-medium rounded-lg w-full">
...
<br>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6">
                ...
                <div class="flex items-baseline">
                    <p class="text-2xl sm:text-3xl font-semibold text-gray-900 dark:text-white">
                        <?php echo e(end($stats['visits_data'])); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6">
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    <div class="bg-blue-50 dark:bg-blue-900 rounded-lg p-4 text-center">
                        ...
                        <p class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e(end($stats['visits_data'])); ?></p>
                    </div>
                    <div class="bg-green-50 dark:bg-green-900 rounded-lg p-4 text-center">
                        ...
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e(array_sum(array_slice($stats['visits_data'], -7))); ?></p>
                    </div>
                    <div class="bg-purple-50 dark:bg-purple-900 rounded-lg p-4 text-center">
                        ...
                        <p class="text-2xl font-bold text-purple-600 dark:text-purple-400"><?php echo e(array_sum($stats['visits_data'])); ?></p>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-6">
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
                        ...
                        <p id="totalCountries" class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($stats['total_countries']); ?></p>
                    </div>
                    <div class="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
                        <p class="text-sm text-gray-600 dark:text-gray-400">أعلى دولة زيارة</p>
                        <p id="topCountry" class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($stats['top_country']); ?></p>
                    </div>
                </div>
                <div class="chart-container h-64 sm:h-80">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
                    ...
                    <div class="mr-4 flex-1">
                        <h4 class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(Str::limit($news->title, 50)); ?></h4>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($news->created_at->diffForHumans()); ?></p>
                    </div>
                    <a href="<?php echo e(route('admin.news.edit', $news)); ?>" class="text-blue-500 hover:text-blue-600 transition-colors duration-200">
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('admin.news.index')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                    عرض كل الأخبار
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(visitsCtx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($stats['visits_labels'], 15, 512) ?>,
            datasets: [{
                label: 'عدد الزيارات',
                data: <?php echo json_encode($stats['visits_data'], 15, 512) ?>,
                borderColor: '#8B5CF6',
    ...
    new Chart(countriesCtx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($country_labels, 15, 512) ?>,
            datasets: [{
                label: 'عدد الزيارات',
                data: <?php echo json_encode($country_data, 15, 512) ?>,
                backgroundColor: [
                    'rgba(54, 162, 235, 0.8)',
                    'rgba(255, 99, 132, 0.8)',
                    'rgba(75, 192, 192, 0.8)',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\temp-laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
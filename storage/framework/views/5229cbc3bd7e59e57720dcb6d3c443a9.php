...
<head>
    ...
    <title>لوحة التحكم - <?php echo e(config('app.name')); ?></title>
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            ...
                            <div class="hidden md:flex items-center mr-4 text-sm text-gray-600 dark:text-gray-400">
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-red-600 dark:hover:text-red-400">
                        ...
                        <div class="flex items-center space-x-3 space-x-reverse">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open" 
                                    ...
                                    <span class="mx-2 text-sm"><?php echo e(auth()->user()->name); ?></span>
...
</html><?php /**PATH C:\xampp\htdocs\temp-laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
...
<div class="w-full mb-4">
    <div class="bg-gradient-to-l from-blue-600 via-blue-500 to-blue-600 dark:from-blue-700 dark:via-blue-600 dark:to-blue-700 px-5 py-4 flex items-center justify-between relative overflow-hidden rounded-t-lg">
        ...
        <?php if($section->category_id && count($news_items) > 6): ?>
        ...
        <div class="bg-white dark:bg-gray-800 p-4 lg:p-6 rounded-b-lg shadow-md">
            <div class="news-grid-mixed">
                <div class="news-grid-top">
                    <?php if($news_items->first()): ?>
                    <div class="news-item news-item-large">
                        <a href="<?php echo e(route('front.news', $news_items->first()->id)); ?>" class="block">
                            <div class="news-image-container">
                                <img src="<?php echo e(url('storage/' . $news_items->first()->image)); ?>"
                                     alt="<?php echo e($news_items->first()->title); ?>"
                                     class="news-image"
                                     loading="lazy">
                                <?php if($news_items->first()->category): ?>
                                    <span class="category-label"><?php echo e($news_items->first()->category->name); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="news-content p-4">
                                <h3 class="news-title text-gray-900 dark:text-gray-100"><?php echo e($news_items->first()->title); ?></h3>
                                <div class="news-excerpt text-gray-600 dark:text-gray-400"><?php echo e(Str::limit(strip_tags($news_items->first()->content), 200)); ?></div>
                            </div>
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="news-grid-top-small">
                        <?php $__currentLoopData = $news_items->slice(1, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a href="<?php echo e(route('front.news', $news->id)); ?>" class="block">
                                <div class="news-image-container">
                                    ...
                                    <?php if($news->category): ?>
                                        <span class="category-label"><?php echo e($news->category->name); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div class="p-3">
                                    <h3 class="news-title text-gray-900 dark:text-gray-100"><?php echo e($news->title); ?></h3>
                                </div>
                            </a>
                        </div>
                ...
                <div class="news-grid-bottom">
                    <?php $__currentLoopData = $news_items->slice(3, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\temp-laravel\resources\views/front/sections/templates/news_grid.blade.php ENDPATH**/ ?>